    ...
    <section className="py-28 md:py-36 bg-background border-y border-white/5 relative">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="text-center mb-20">
          ...
          >
            What Our{" "}
            <span className="text-secondary drop-shadow-[0_0_15px_rgba(6,182,212,0.5)]">Users Say</span>
          </motion.h2>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {reviews.map((rev, idx) => (
            ...
            >
              ...
              <p className="text-white/80 italic mb-10 leading-relaxed text-base">"{rev.text}"</p>
